...
// ---------------------------
// 🔍 Widget: Thanh tìm kiếm trên menu
// ---------------------------
function twentytwenty_header_widget_search_init()
{
	register_sidebar(array(
		'name'          => __('Header Search Widget', 'twentytwenty'),
		'id'            => 'header-search-widget',
		'description'   => __('Add a search form or widget to appear in your site header.', 'twentytwenty'),
		'before_widget' => '<div id="%1$s" class="header-widget header-widget-search %2$s">',
		'after_widget'  => '</div>',
	));
}
